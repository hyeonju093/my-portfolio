...
export default function App() {
  const projectList = [
    {
      title: "캡스톤디자인(낙상감지시스템)-팀",
      period: "2025.02 - 2025.11  [기여도: 6/10]",
      description:
        "인공지능(MediaPipe, PyTorch)과 Django를 결합하여 실시간 낙상 감지 시스템을 제작했습니다 저는 팀프젝트에서 프론트엔드 구현을 맡았고 HTML을 사용해 프론트엔드를 구현했습니다",
      detailDescription: `\n기술 스택 : HTML5, CSS, JavaScript, Flask, OpenCV\n주요 기능: 동적 상태 알림 UI, 끊김 없는 영상 스트리밍, 관리자용 대시보드 레이아웃
...
4. 개발 과정에서의 도전\n- 리소스 최적화 : 브라우저에서 실시간 스트림과 딥러닝 추론 결과를 동시에 보여주는 것은 부하가 크기 때문에 <img> 태그를 사용하여 대시보드의 성능저하를 방지했습니다`,
      image: "/assets/teamprojectimg.jpg",
...
3. 서버 컴포넌트 아키텍처 : 타이핑 효과 및 슬라이더, 모달 등 인터랙션이 필요한 영역만 클라이언트 컴포넌트로 분리 설계했습니다.`,
    ...
    },
    {
      ...
      period: "2026.01",
      description:
        "React와 Redux Toolkit, Axios를 활용해 실무에서 많이 활용되는 기능으로 구현된 쇼핑몰 사이트를 제작하였습니다",
...
- 컴포넌트 설계 : 반복되는 UI를 효율적으로 관리하기 위한 재사용성에 대해 고민하고 다양한 곳에서 쓰이는 모달 창을 공통 컴포넌트로 분리하여 코드의 중복을 줄이고 UI 일관성을 유지했습니다`,
      image: "/assets/shoppingmallimg.jpg",
      tags: ["React", "Redux Toolkit", "CSS Modules", "REST API"],
      link: "https://github.com/hyeonju093/shopping-mall-react",
    },
    {
      title: "습관 관리 어플 구현-개인",
      period: "2026.01 - 2026.02",
      description:
        "React Native와 Zustand, Firebase를 활용해 하루의 습관을 관리하는 어플리케이션을 제작했습니다",
  ...
  return (
    <div className="App">
      <nav className="navbar">
        <h1 className="logo">hyeonju ' s portfolio</h1>
      ...
      <footer id="contact" className="footer-container">
        <div className="contact-info">
          ...
          <h2 className="contact-item">email : ghdguswn6@naver.com</h2>
        </div>
